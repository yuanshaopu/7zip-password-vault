...
void CExtractCallbackConsole::SetPasswordDefined(bool defined)
{
  PasswordIsDefined = defined;
}

void CExtractCallbackConsole::SetTryMode(bool /* tryMode */)
{
}

void CExtractCallbackConsole::ResetErrors()
{
  ThereIsError_in_Current = false;
  NumFileErrors_in_Current = 0;
}

bool CExtractCallbackConsole::Get_PasswordIsDefined() const
{
  return PasswordIsDefined;
}

bool CExtractCallbackConsole::Get_IsOK() const
{
  return !ThereIsError_in_Current;
}

bool CExtractCallbackConsole::Get_TryIsOK() const
{
  return !ThereIsError_in_Current;
}

UInt32 CExtractCallbackConsole::Get_NumBatchErrors() const
{
  return ThereIsError_in_Current ? 1 : 0;
}
