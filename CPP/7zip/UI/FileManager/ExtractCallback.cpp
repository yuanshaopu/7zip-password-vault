...
void CExtractCallbackImp::SetPasswordDefined(bool defined)
{
  PasswordIsDefined = defined;
}

void CExtractCallbackImp::SetTryMode(bool tryMode)
{
  PasswordTryMode = tryMode;
}

bool CExtractCallbackImp::Get_IsOK() const
{
  return NumBatchErrors == 0;
}

bool CExtractCallbackImp::Get_TryIsOK() const
{
  return NumArchiveErrors == 0 && !ThereAreMessageErrors;
}

UInt32 CExtractCallbackImp::Get_NumBatchErrors() const
{
  return NumBatchErrors;
}

void CExtractCallbackImp::ResetErrors()
{
  NumArchiveErrors = 0;
  ThereAreMessageErrors = false;
}

bool CExtractCallbackImp::Get_PasswordIsDefined() const
{
