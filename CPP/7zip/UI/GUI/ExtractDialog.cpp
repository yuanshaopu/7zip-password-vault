...
bool CExtractDialog::OnInit()
{
  ...
  CheckButton(IDX_EXTRACT_TRY_VAULT, _info.TryPasswordVault.Val);
  CheckButton(IDX_EXTRACT_DELETE_AFTER_OK, _info.DeleteAfterExtract.Val);
...
void CExtractDialog::OnOK()
{
  ...
  TryPasswordVault = IsButtonCheckedBool(IDX_EXTRACT_TRY_VAULT);
  DeleteAfterExtract = IsButtonCheckedBool(IDX_EXTRACT_DELETE_AFTER_OK);

  if (TryPasswordVault != _info.TryPasswordVault.Val)
  {
    _info.TryPasswordVault.Def = true;
    _info.TryPasswordVault.Val = TryPasswordVault;
  }
  if (DeleteAfterExtract != _info.DeleteAfterExtract.Val)
  {
    _info.DeleteAfterExtract.Def = true;
    _info.DeleteAfterExtract.Val = DeleteAfterExtract;
  }
